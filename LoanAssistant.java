...
public class LoanAssistant extends JFrame{
    ...
    public LoanAssistant() {
        ...
        private void computeButtonActionPerformed(ActionEvent e) {
            ...
            if(computePayments){
                ...
                if(validateDecimalNumber(paymentTextField)){
                    ...
                    JOptionPane.showConfirmDialog(null,
                            "Invalid or empty Monthly Payment entry.\nPlease correct.",
                            "Payment Input Error",
                            JOptionPane.DEFAULT_OPTION,
                            JOptionPane.INFORMATION_MESSAGE);
                    return;
            ...
            analysisTextArea.append("\n\n" + String.valueOf(months-1)
                    + " Payment of $ " + new DecimalFormat("0.00").format(payment));
            analysisTextArea.append("\n" + "Final payment of: $ "
        ...
        private void monthsButtonActionPeformed(ActionEvent e) {
